...
class UserAccount(AbstractUser):
    ...
    rol_id = models.IntegerField(
        default=2,
        help_text="1: Admin, 2: Cliente/Usuario"
    )
    ...
    email_verified = models.BooleanField(
        default=False,
        help_text="Indica si el email ha sido verificado (allauth)"
    )
    ...
    use_allauth = models.BooleanField(
        default=False,
        help_text="Usuario migrado al nuevo sistema de autenticación con allauth"
    )
    ...
    identificacion = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Número de identificación (CC, NIT, etc.)"
    )
    ...
    last_password_change = models.DateTimeField(
        blank=True,
        null=True,
        help_text="Última vez que cambió la contraseña"
    )
