...
class CacheService:
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                if args or kwargs:
                    ...
                    key_suffix = hashlib.sha256(args_str.encode()).hexdigest()[:8]
    ...
    def cache_analytics_report(report_type, params, timeout=TIMEOUT_SHORT):
        ...
        cache_key = f"analytics:{report_type}:{hashlib.sha256(param_str.encode()).hexdigest()}"
    ...
    def get_cache_stats():
        ...
        """
        return {"backend": "FileBasedCache", "note": "Cambia a Redis en producción para stats completas"}
